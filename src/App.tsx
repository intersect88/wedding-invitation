              ...
              >
               ...
               {showIban && (
                 <div className="iban-section" id="iban-section">
                   ...
                   <p className="iban-label">Il regalo più bello sarà<span className="iban-br"><br /></span> il nostro viaggio di nozze</p>
                   <p className="iban-prefix">IBAN:</p>
                   <p className="iban-code" style={{fontFamily: 'Arial, sans-serif'}}>IT13K0538739840000003548644</p>
                   <p className="iban-note">Intestato a:<span className="iban-br"><br /></span> Paudice Genny &amp; Annunziata Ornella</p>
                 </div>
               )}
            </div>

            <p className="footer-message">Non vediamo l'ora di festeggiare con voi!</p>
            <p className="footer-rsvp">(È gradita gentile conferma di partecipazione)</p>
          </div>
        </div>
      </div>
      </div>
